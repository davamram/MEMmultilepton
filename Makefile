...
#TTLL_EFT
TTLL_EFT_MADLIBDIR=src/Madgraph/PROC_SA_CPP_dim6top_LO_UFO_all_DECAY_ggttll/lib
TTLL_EFT_MADINCDIR=src/Madgraph/PROC_SA_CPP_dim6top_LO_UFO_all_DECAY_ggttll/src
TTLL_EFT_MADMODELLIB=model_dim6top_LO_UFO_all_ggttll
TTLL_EFT_MADPROCESS_0=CPPProcess_P1_Sigma_dim6top_LO_UFO_all_gg_ttxepem
TTLL_EFT_MADPROCDIR_0=src/Madgraph/PROC_SA_CPP_dim6top_LO_UFO_all_DECAY_ggttll/SubProcesses/P1_Sigma_dim6top_LO_UFO_all_gg_ttxepem
TTLL_EFT_MADPROCESS_1=CPPProcess_P1_Sigma_dim6top_LO_UFO_all_gg_ttxmupmum
TTLL_EFT_MADPROCDIR_1=src/Madgraph/PROC_SA_CPP_dim6top_LO_UFO_all_DECAY_ggttll/SubProcesses/P1_Sigma_dim6top_LO_UFO_all_gg_ttxmupmum
...
objects = ${memobjects} ${processobjects} ${modelobjects} ${TTLL_EFT_MADPROCDIR_0}/${TTLL_EFT_MADPROCESS_0}.o ${TTLL_EFT_MADPROCDIR_1}/${TTLL_EFT_MADPROCESS_1}.o ${TTLL_EFT_ONLY_MADPROCDIR_0}/${TTLL_EFT_ONLY_MADPROCESS_0}.o ${TTLL_EFT_ONLY_MADPROCDIR_1}/${TTLL_EFT_ONLY_MADPROCESS_1}.o
...
${TTLL_EFT_MADPROCDIR_0}/${TTLL_EFT_MADPROCESS_0}.o: ${TTLL_EFT_MADPROCDIR_0}/${TTLL_EFT_MADPROCESS_0}.cc ${TTLL_EFT_MADLIBDIR}/lib${TTLL_EFT_MADMODELLIB}.a
		${CXX} -l${LIBS} ${CXXFLAGS} -c ${TTLL_EFT_MADPROCDIR_0}/${TTLL_EFT_MADPROCESS_0}.cc

${TTLL_EFT_MADPROCDIR_1}/${TTLL_EFT_MADPROCESS_1}.o: ${TTLL_EFT_MADPROCDIR_1}/${TTLL_EFT_MADPROCESS_1}.cc ${TTLL_EFT_MADLIBDIR}/lib${TTLL_EFT_MADMODELLIB}.a
		${CXX} -l${LIBS} ${CXXFLAGS} -c ${TTLL_EFT_MADPROCDIR_1}/${TTLL_EFT_MADPROCESS_1}.cc
