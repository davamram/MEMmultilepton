...
#TTH
TTH_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_4/lib
TTH_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_4/src
TTH_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_4/SubProcesses/P0_Sigma_sm_gg_ttxh
TTH_MADMODELLIB=model_sm

#T->bW->bjj
THAD_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwjj/lib
THAD_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwjj/src
THAD_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwjj/SubProcesses/P0_Sigma_sm_t_budx
THAD_MADMODELLIB=model_sm_tbwjj

#Anti T->bW->bjj
ATHAD_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_antitbwjj/lib
ATHAD_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_antitbwjj/src
ATHAD_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_antitbwjj/SubProcesses/P0_Sigma_sm_tx_bxdux
ATHAD_MADMODELLIB=model_sm_antitbwjj

#T->bW->blnu
TLEP_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwlnu/lib
TLEP_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwlnu/src
TLEP_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_tbwlnu/SubProcesses/P0_Sigma_sm_t_bepve
TLEP_MADMODELLIB=model_sm_tbwlnu

#H->WW->2l2nu
H2L2NU_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_hw2l2nu/lib
H2L2NU_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_hw2l2nu/src
H2L2NU_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_hw2l2nu/SubProcesses/P0_Sigma_sm_h_epveemvex
H2L2NU_MADMODELLIB=model_sm_hw2l2nu

#TTGamma*
TTLL_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggttll/lib
TTLL_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggttll/src
TTLL_MADPROCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggttll/SubProcesses/P0_Sigma_sm_gg_ttxepem
TTLL_MADMODELLIB=model_sm_ggttll

#TTW+
TTWP_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlpvl/lib
TTWP_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlpvl/src
...
TTWP_MADPROCDIR_udx=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlpvl/SubProcesses/P0_Sigma_sm_ckm_udx_ttxepve
TTWP_MADPROCDIR_cdx=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlpvl/SubProcesses/P0_Sigma_sm_ckm_cdx_ttxepve
TTWP_MADPROCDIR_usx=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlpvl/SubProcesses/P0_Sigma_sm_ckm_usx_ttxepve
TTWP_MADMODELLIB=model_sm_ckm_qqttlpvl

#TTW-
TTWM_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlmvl/lib
TTWM_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlmvl/src
...
TTWM_MADPROCDIR_dux=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlmvl/SubProcesses/P0_Sigma_sm_ckm_dux_ttxemvex
TTWM_MADPROCDIR_dcx=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlmvl/SubProcesses/P0_Sigma_sm_ckm_dcx_ttxemvex
TTWM_MADPROCDIR_sux=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_qqttlmvl/SubProcesses/P0_Sigma_sm_ckm_sux_ttxemvex
TTWM_MADMODELLIB=model_sm_ckm_qqttlmvl

#TTWPJJ
TTWPJJ_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/lib
TTWPJJ_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/src
TTWPJJ_MADMODELLIB=model_sm_ckm_ppttlpvljj
TTWPJJ_MADPROCESS_0=CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd
TTWPJJ_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gc_ttxepvegd
TTWPJJ_MADPROCESS_1=CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegcx
TTWPJJ_MADPROCDIR_1=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gdx_ttxepvegcx
TTWPJJ_MADPROCESS_2=CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux
TTWPJJ_MADPROCDIR_2=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gdx_ttxepvegux
TTWPJJ_MADPROCESS_3=CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux
TTWPJJ_MADPROCDIR_3=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gsx_ttxepvegux
TTWPJJ_MADPROCESS_4=CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd
TTWPJJ_MADPROCDIR_4=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gu_ttxepvegd
TTWPJJ_MADPROCESS_5=CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs
TTWPJJ_MADPROCDIR_5=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlpvljj/SubProcesses/P0_Sigma_sm_ckm_gu_ttxepvegs

#TTWMJJ
TTWMJJ_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/lib
TTWMJJ_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/src
TTWMJJ_MADMODELLIB=model_sm_ckm_ppttlmvljj
TTWMJJ_MADPROCESS_0=CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx
TTWMJJ_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gcx_ttxemvexgdx
TTWMJJ_MADPROCESS_1=CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc
TTWMJJ_MADPROCDIR_1=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gd_ttxemvexgc
TTWMJJ_MADPROCESS_2=CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu
TTWMJJ_MADPROCDIR_2=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gd_ttxemvexgu
TTWMJJ_MADPROCESS_3=CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu
TTWMJJ_MADPROCDIR_3=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gs_ttxemvexgu
TTWMJJ_MADPROCESS_4=CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx
TTWMJJ_MADPROCDIR_4=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gux_ttxemvexgdx
TTWMJJ_MADPROCESS_5=CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgsx
TTWMJJ_MADPROCDIR_5=data/Madgraph/PROC_SA_CPP_sm_ckm_DECAY_ppttlmvljj/SubProcesses/P0_Sigma_sm_ckm_gux_ttxemvexgsx

#TTbar
TTbar_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggtt/lib
TTbar_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggtt/src
TTbar_MADMODELLIB=model_sm_ggtt
TTbar_MADPROCESS_0=CPPProcess_P0_Sigma_sm_gg_ttx
TTbar_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_DECAY_ggtt/SubProcesses/P0_Sigma_sm_gg_ttx

#TLLQ
TLLQ_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/lib
TLLQ_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/src
TLLQ_MADMODELLIB=model_sm_no_b_mass_pptllq
TLLQ_MADPROCESS_0=CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu
TLLQ_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/SubProcesses/P0_Sigma_sm_no_b_mass_dbx_txepemu
TLLQ_MADPROCESS_1=CPPProcess_P0_Sigma_sm_no_b_mass_dxb_tepemux
TLLQ_MADPROCDIR_1=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/SubProcesses/P0_Sigma_sm_no_b_mass_dxb_tepemux
TLLQ_MADPROCESS_2=CPPProcess_P0_Sigma_sm_no_b_mass_ub_tepemd
TLLQ_MADPROCDIR_2=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/SubProcesses/P0_Sigma_sm_no_b_mass_ub_tepemd
TLLQ_MADPROCESS_3=CPPProcess_P0_Sigma_sm_no_b_mass_uxbx_txepemdx
TLLQ_MADPROCDIR_3=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_pptllq/SubProcesses/P0_Sigma_sm_no_b_mass_uxbx_txepemdx

#WZJJ
WZJJ_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_gqlnullgq/lib
WZJJ_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_DECAY_gqlnullgq/src
WZJJ_MADMODELLIB=model_sm_gqlnullgq
WZJJ_MADPROCESS_0=CPPProcess_P0_Sigma_sm_gdx_epvemupmumgux
WZJJ_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_DECAY_gqlnullgq/SubProcesses/P0_Sigma_sm_gdx_epvemupmumgux
WZJJ_MADPROCESS_1=CPPProcess_P0_Sigma_sm_gu_epvemupmumgd
WZJJ_MADPROCDIR_1=data/Madgraph/PROC_SA_CPP_sm_DECAY_gqlnullgq/SubProcesses/P0_Sigma_sm_gu_epvemupmumgd

#THQ
THQ_MADLIBDIR=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/lib
THQ_MADINCDIR=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/src
THQ_MADMODELLIB=model_sm_no_b_mass_ppthq
THQ_MADPROCESS_0=CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txhu
THQ_MADPROCDIR_0=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/SubProcesses/P0_Sigma_sm_no_b_mass_dbx_txhu
THQ_MADPROCESS_1=CPPProcess_P0_Sigma_sm_no_b_mass_dxb_thux
THQ_MADPROCDIR_1=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/SubProcesses/P0_Sigma_sm_no_b_mass_dxb_thux
THQ_MADPROCESS_2=CPPProcess_P0_Sigma_sm_no_b_mass_ub_thd
THQ_MADPROCDIR_2=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/SubProcesses/P0_Sigma_sm_no_b_mass_ub_thd
THQ_MADPROCESS_3=CPPProcess_P0_Sigma_sm_no_b_mass_uxbx_txhdx
THQ_MADPROCDIR_3=data/Madgraph/PROC_SA_CPP_sm_no_b_mass_DECAY_ppthq/SubProcesses/P0_Sigma_sm_no_b_mass_uxbx_txhdx
