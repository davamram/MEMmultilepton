...
namespace MG5_dim6top_LO_UFO_ctl2_ggttll 
{
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP2 = (F1[2] * F4[2] * (F2[4] * F3[4] + F2[5] * F3[5]) + F1[3] * F4[3] *
      (F2[4] * F3[4] + F2[5] * F3[5]));
    ...
    std::complex<double> F2[])
{
  ...
  F2[4] = denom * 2. * cI * F3[4] * M2 * (F1[2] * F4[2] + F1[3] * F4[3]); 
  F2[5] = denom * 2. * cI * F3[5] * M2 * (F1[2] * F4[2] + F1[3] * F4[3]); 
}
    ...
    std::complex<double> F3[])
{
  ...
  F3[4] = denom * 2. * cI * F2[4] * M3 * (F1[2] * F4[2] + F1[3] * F4[3]); 
  F3[5] = denom * 2. * cI * F2[5] * M3 * (F1[2] * F4[2] + F1[3] * F4[3]); 
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  V3[4] = denom * (-cI) * (-cI * (F1[2] * F2[5]) + cI * (F1[3] * F2[4]) - P3[2]
      * OM3 * TMP3);
  V3[5] = denom * (-cI) * (-F1[2] * F2[4] - P3[3] * OM3 * TMP3 + F1[3] *
      F2[5]);
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  V3[3] = denom * 2. * cI * (OM3 * 1./2. * P3[1] * (TMP3 - 2. * (TMP4)) +
      ...
      F2[2]));
  V3[4] = denom * (-2. * cI) * (OM3 * 1./2. * P3[2] * (-TMP3 + 2. * (TMP4)) +
      (-1./2. * cI * (F1[2] * F2[5]) + 1./2. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * (-2. * cI) * (OM3 * 1./2. * P3[3] * (-TMP3 + 2. * (TMP4)) +
...
}  // end namespace $(namespace)s_dim6top_LO_UFO_ctl2_ggttll
