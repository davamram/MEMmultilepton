...
#ifndef HelAmps_dim6top_LO_UFO_ctl2_ggttll_H
#define HelAmps_dim6top_LO_UFO_ctl2_ggttll_H
...
}  // end namespace MG5_dim6top_LO_UFO_ctl2_ggttll

#endif  // HelAmps_dim6top_LO_UFO_ctl2_ggttll_H
