...
#include "CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem.h"
...
void CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem::initProc(string param_card_name) 
{
...
void CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem::sigmaKin() 
{
...
double CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem::sigmaHat() 
{
...
void CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_gg_ttxepem::matrix_1_gg_ttxepem() 
{
  int i, j; 
  // Local variables
