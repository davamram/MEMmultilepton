...
#ifndef Parameters_dim6top_LO_UFO_all_ggttll_H
#define Parameters_dim6top_LO_UFO_all_ggttll_H
...
class Parameters_dim6top_LO_UFO_all_ggttll
{
  public:

    static Parameters_dim6top_LO_UFO_all_ggttll * getInstance(); 
  ...
  private:
    static Parameters_dim6top_LO_UFO_all_ggttll * instance; 
}; 

#endif  // Parameters_dim6top_LO_UFO_all_ggttll_H
