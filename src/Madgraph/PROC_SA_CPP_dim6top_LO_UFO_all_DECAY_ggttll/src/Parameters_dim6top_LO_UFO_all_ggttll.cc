...
#include <iostream> 
#include <iomanip> 
#include "Parameters_dim6top_LO_UFO_all_ggttll.h"

// Initialize static instance
Parameters_dim6top_LO_UFO_all_ggttll * Parameters_dim6top_LO_UFO_all_ggttll::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_dim6top_LO_UFO_all_ggttll * Parameters_dim6top_LO_UFO_all_ggttll::getInstance()
{
  if (instance == 0)
    instance = new Parameters_dim6top_LO_UFO_all_ggttll(); 

  return instance; 
}

void Parameters_dim6top_LO_UFO_all_ggttll::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_dim6top_LO_UFO_all_ggttll::setIndependentCouplings()
{
...
void Parameters_dim6top_LO_UFO_all_ggttll::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = ((G) * (G)); 
}
void Parameters_dim6top_LO_UFO_all_ggttll::setDependentCouplings()
{
  GC_6 = -G; 
  GC_7 = mdl_complexi * G; 
}
...
void Parameters_dim6top_LO_UFO_all_ggttll::printIndependentParameters()
{
  cout <<  "dim6top_LO_UFO_all model parameters independent of event kinematics:" <<
      endl;
...
void Parameters_dim6top_LO_UFO_all_ggttll::printIndependentCouplings()
{
  cout <<  "dim6top_LO_UFO_all model couplings independent of event kinematics:" <<
      endl;
...
void Parameters_dim6top_LO_UFO_all_ggttll::printDependentParameters()
{
  cout <<  "dim6top_LO_UFO_all model parameters dependent on event kinematics:"
      << endl;
...
void Parameters_dim6top_LO_UFO_all_ggttll::printDependentCouplings()
{
  cout <<  "dim6top_LO_UFO_all model couplings dependent on event kinematics:"
      << endl;
