...
#include "CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_17_ddx_bepvebxmumvmxmupmum.h"
#include "rambo.h"

int main(int argc, char** argv){

  // Create a process object
  CPPProcess_P1_Sigma_dim6top_LO_UFO_ctl2_17_ddx_bepvebxmumvmxmupmum process;
