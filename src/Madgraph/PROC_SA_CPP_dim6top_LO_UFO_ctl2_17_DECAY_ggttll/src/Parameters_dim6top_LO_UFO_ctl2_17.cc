...
Parameters_dim6top_LO_UFO_ctl2_17 * Parameters_dim6top_LO_UFO_ctl2_17::instance
    = 0;

// Function to get static instance - only one instance per program
Parameters_dim6top_LO_UFO_ctl2_17 * Parameters_dim6top_LO_UFO_ctl2_17::getInstance()
{
  if (instance == 0)
    instance = new Parameters_dim6top_LO_UFO_ctl2_17(); 

  return instance; 
}

void Parameters_dim6top_LO_UFO_ctl2_17::setIndependentParameters(SLHAReader&
    slha)
{
  // Define "zero"
  zero = 0; 
...
void Parameters_dim6top_LO_UFO_ctl2_17::setIndependentCouplings()
{
...
void Parameters_dim6top_LO_UFO_ctl2_17::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = ((G) * (G)); 
}
void Parameters_dim6top_LO_UFO_ctl2_17::setDependentCouplings()
{
  GC_6 = -G; 
  GC_7 = mdl_complexi * G; 
}
...
void Parameters_dim6top_LO_UFO_ctl2_17::printIndependentParameters()
{
  cout <<  "dim6top_LO_UFO_ctl2_17 model parameters independent of event kinematics:" <<
      endl;
...
void Parameters_dim6top_LO_UFO_ctl2_17::printIndependentCouplings()
{
  cout <<  "dim6top_LO_UFO_ctl2_17 model couplings independent of event kinematics:" <<
      endl;
  ...
  cout << setw(20) <<  "GC_3 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3 << endl;
  cout << setw(20) <<  "GC_649 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_649 << endl;
...
void Parameters_dim6top_LO_UFO_ctl2_17::printDependentParameters()
{
  cout <<  "dim6top_LO_UFO_ctl2_17 model parameters dependent on event kinematics:" <<
      endl;
...
void Parameters_dim6top_LO_UFO_ctl2_17::printDependentCouplings()
{
  cout <<  "dim6top_LO_UFO_ctl2_17 model couplings dependent on event kinematics:" <<
      endl;
