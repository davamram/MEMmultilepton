...
namespace MG5_dim6top_LO_UFO_ctl2_17 
{
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> V1[])
{
  ...
  V1[2] = denom * (TMP8 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[2] * (+cI * (TMP6) - cI * (TMP7))));
  V1[3] = denom * (TMP8 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[3] * (+cI * (TMP6) - cI * (TMP7))));
  V1[4] = denom * (TMP8 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[4] * (+cI * (TMP6) - cI * (TMP7))));
  V1[5] = denom * (TMP8 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[5] * (+cI * (TMP6) - cI * (TMP7))));
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP9 = (F1[2] * F4[2] * (F2[4] * F3[4] + F2[5] * F3[5]) + F1[3] * F4[3] *
      (F2[4] * F3[4] + F2[5] * F3[5]));
...
}  // end namespace $(namespace)s_dim6top_LO_UFO_ctl2_17
