...
#ifndef Parameters_sm_tbwlnu_H
#define Parameters_sm_tbwlnu_H
...
class Parameters_sm_tbwlnu
{
  public:

    static Parameters_sm_tbwlnu * getInstance(); 
  ...
  private:
    static Parameters_sm_tbwlnu * instance; 
}; 

#endif  // Parameters_sm_tbwlnu_H
