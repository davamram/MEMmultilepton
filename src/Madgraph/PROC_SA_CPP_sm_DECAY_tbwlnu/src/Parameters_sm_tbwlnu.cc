...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm_tbwlnu.h"

// Initialize static instance
Parameters_sm_tbwlnu * Parameters_sm_tbwlnu::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_tbwlnu * Parameters_sm_tbwlnu::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_tbwlnu(); 

  return instance; 
}

void Parameters_sm_tbwlnu::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_tbwlnu::setIndependentCouplings()
{
  GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}
void Parameters_sm_tbwlnu::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = pow(G, 2.); 
}
void Parameters_sm_tbwlnu::setDependentCouplings()
{

}

// Routines for printing out parameters
void Parameters_sm_tbwlnu::printIndependentParameters()
{
...
void Parameters_sm_tbwlnu::printDependentCouplings()
{
